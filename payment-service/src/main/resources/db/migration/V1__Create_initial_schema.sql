...
(
    ...
    BIGINT
    NOT
    NULL, -- Cross-domain reference (from db_order.orders)
...
(
    ...
    INDEX idx_payments_gateway_transaction_id
(
...
(
    ...
    INDEX idx_payments_gateway_provider
(
    gateway_provider
),
    INDEX idx_payments_payment_method_type
(
    payment_method_type
),
...
(
    id
                                                           ...
                                                           ON DELETE CASCADE,
    INDEX idx_payment_refunds_payment_id
(
    payment_id
),
    INDEX idx_payment_refunds_refund_number
(
    refund_number
),
    INDEX idx_payment_refunds_status
(
    status
),
    INDEX idx_payment_refunds_created_at
(
    created_at
)
    ) ENGINE = InnoDB

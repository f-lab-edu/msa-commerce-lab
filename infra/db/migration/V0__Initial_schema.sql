...
(
    ...
    INDEX idx_product_sales_updated (last_updated_at),
...
(
    ...
    INDEX idx_user_order_updated (last_updated_at),
...
(
    ...
    INDEX idx_daily_business_updated (last_updated_at)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci;
...
-- 초기화 스크립트 완료 확인
INSERT IGNORE INTO daily_business_metrics (business_date)
VALUES (CURRENT_DATE);

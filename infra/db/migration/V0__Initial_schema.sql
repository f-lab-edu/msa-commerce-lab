...
ALTER TABLE notifications ADD INDEX idx_notifications_recipient_status (recipient_type, status);
ALTER TABLE payment_settlement_events ADD INDEX idx_settlement_events_date_provider (settlement_target_date, gateway_provider);
ALTER TABLE daily_settlements ADD INDEX idx_daily_settlements_date_status (settlement_date, status);
ALTER TABLE weekly_settlements ADD INDEX idx_weekly_settlements_dates (week_start_date, week_end_date);
ALTER TABLE monthly_settlements ADD INDEX idx_monthly_settlements_dates (month_start_date, month_end_date);

-- Views for reporting
CREATE VIEW v_settlement_performance AS
...
CREATE VIEW v_monthly_settlement_trend AS
SELECT ms.settlement_year_month,
       ...
       ms.peak_day,
       ms.peak_day_amount,
       LAG(ms.total_gross_amount) OVER (ORDER BY ms.settlement_year_month) AS prev_month_gross,
       ROUND(
